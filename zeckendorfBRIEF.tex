...
\textit{Proof.} Induction over $n$. Use Lemma~\ref{lem.2} to show that $\max T<\max
...
\textit{Proof of Theorem~\ref{thm.7}.} Since $S$ is a lacunar subset of $\mathbb{N}_{2}%
...
computations). This proves Theorem~\ref{thm.7}.
...
\textit{Proof of Theorem~\ref{thm.8}.} Choose a high enough integer $N$. What exactly
...
\textit{Proof of Lemma~\ref{lem.9}.} Let%
\begin{equation}
