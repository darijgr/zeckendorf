...
%TCIDATA{LastRevised=Thursday, February 22, 2018 21:29:59}
...
\begin{remark}
\textbf{1)} The \textit{Zeckendorf family identities}\footnotemark\ from
\cite{1} are the result of applying Theorem~\ref{thm.1} to the case when all
$a_{t}$ are $=0$.
