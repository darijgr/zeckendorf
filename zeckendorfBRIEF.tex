...
%TCIDATA{LastRevised=Thursday, February 22, 2018 20:43:46}
...
\begin{abstract}
\textbf{Abstract.}
In \cite{1}, Philip Matchett Wood and Doron Zeilberger have constructed identities
...
\begin{statement}
This is a brief version of my note \cite{this.long}. For more detailed proofs, see \cite{this.long} (but
beware that \cite{this.long} is sometimes over-precise and very boring).
...
\textit{Zeckendorf family identities} which were discussed in \cite{1}. First, some definitions:
...
\end{align*}
} from \cite{1} are the result of applying Theorem 1 to the case when all $a_{t}$
are $=0$.
...
generalized}, version 7, 22 March 2011 *long version*.\newline%
